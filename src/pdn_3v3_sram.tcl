...
puts "PDN vertical width $::env(PDN_VWIDTH)"
puts "PDN vertical pitch $::env(PDN_VPITCH)"
puts "PDN vertical offset $::env(PDN_VOFFSET)"
puts "PDN vertical spacing $::env(PDN_VSPACING)"
